...
//            removeIrrelevant();
//            for (Variable v : this.net.getNet()) {
...
//        this.query = net.getVariable(query_name);
//
...
//            Variable e = this.net.getVars(evidence_name);
//            e.setEvidence();
//            this.evidence.add(e);
...
//            if(this.net.getVariable(hidden) == null){
...
//            if(BayesBallAlgo.Bayes(this.net, q).equals("yes")){
//                deleteChildren(this.net.getVariable(hidden));
...
//                    }
//                    this.net.removeVariable(hidden.getChildren().get(i));
//                }
//            }
//        }
//    }
...
//            String[] v_outcomes = this.net.getVariable(s).getOutcomes();
...
//                    }
//                    int number_of_hidden_outcomes = this.net.getVariable(hidden_name).getOutcomes().length;
